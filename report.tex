...
outside (and the elevator no longer jumps between the floors). Although not presented in the table, we have also made several other tests with good results, for example with five simultaneous elevators.
